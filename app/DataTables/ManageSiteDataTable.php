...
class ManageSiteDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return datatables()
            ...
            ->addColumn('action', function (Site $site) {
                return view('site.action', compact('site'));
            })
    ...
    public function html(): HtmlBuilder
    {
        ...
        $canExportSite = \Auth::user()->can('export-analytics-dashboard');
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('site_name')->title(__('Name')),
    ...
    {
        return 'ManageSite_' . date('YmdHis');
    }
}
