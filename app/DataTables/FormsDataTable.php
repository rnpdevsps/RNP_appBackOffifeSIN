...
class FormsDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('id')->title('<div><input type="checkbox" data-checkboxes="mygroup" data-checkbox-role="dad" name="checkbox-all" class="p-2 form-check-input dt-checkboxes-cell dt-checkboxes-select-all"></div>')->exportable(false)->printable(false)->searchable(false)->orderable(false),
