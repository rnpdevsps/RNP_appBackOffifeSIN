{!! Form::open(['route' => 'ChangeStatusUser', 'method' => 'Post', 'data-validate','enctype' => 'multipart/form-data']) !!}
...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group">
            {!! Form::hidden('notario_id', $user->id, ['class' => 'form-control']) !!}
    ...
    <div class="row">
    	...
    	<div class="col-md-12">
            <div class="form-group">
                {{ Form::label('adjunto', __('Archivos'), ['class' => 'form-label']) }} *
                <small class="text-end d-flex mt-2">{{ __('Adjunte un archivo PDF') }}</small>
                {!! Form::file('adjunto', ['class' => 'form-control', 'required' => 'required']) !!}
            </div>
        </div>
