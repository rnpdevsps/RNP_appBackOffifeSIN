@php
    ...
    if (isset($user->color_flag) && $user->color_flag == 'true') {
        $color = 'custom-color';
    } else {
        $color = $primaryColor ? $primaryColor : 'theme-2';
    }
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/css/custom-color.css') }}">
...
<body class="{{ $color }}">
    ...
    <div class="modal fade modal-animate anim-blur" role="dialog" id="common_modal_g">
    ...
    <div class="modal fade modal-animate anim-blur" role="dialog" tabindex="-1" id="common_modal_xl">
                    ...
                    success: function(response) {
                        if (response.mode == 1) {
                            ...
                            document.querySelector("#telescope-style-link").setAttribute("href",
                                "{{ asset('assets/css/telescope-dark.css') }}"
                            );
                        } else {
                            ...
                            document.querySelector("#telescope-style-link").setAttribute("href",
                                "{{ asset('assets/css/telescope.css') }}"
                            );
                        }
                    }
                });
