...
@section('content')
    ...
    <div class="row">
        <div class="mx-auto mt-5 col-xl-10 col-lg-10">
            <div class="p-5 card">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                            ...
                                            <span class="text-left comment-info">
                                                ...
                                                <h6 class="d-block">
                                                    ...
                                                    <a href="#reply-comment"
                                                        ...
                                                        {{ __('Reply') }}</i></a>
                                                    {!! html()->form('DELETE', route('comment.destroy', $value->id))->attribute('id', 'delete-form-' . $value->id)->attribute('class', 'd-inline')->close() !!}
                                                    {!! html()->form()->close() !!}
                                                </h6>
