                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                @if ($poll->allow_comments == 1)
                                    <div class="card">
                                        ...
                                        {!! html()->form('POST', route('comment.store'))->open() !!}
                                        <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            @foreach ($poll->commmant as $value)
                                                ...
                                                {!! html()->form('POST', route('comment.reply.store'))->attribute('data-validate')->open() !!} <div class="row commant"
                                                    id="reply-comment-{{ $value->id }}">
                                                    <div class="form-group">
                                                        {!! html()->text('name')->class('form-control')->required()->placeholder(__('Enter your name')) !!} </div>
                                                    <div class="form-group">

                                                        {!! html()->textarea('reply')->class('form-control')->rows(2)->required()->placeholder(__('Add a comment')) !!} </div>
                                                    <input type="hidden" id="poll_id" name="poll_id"
                                                        value="{{ $poll->id }}">
