                    ...
                    <div class="row">
                        <div class="col-xl-12 order-xl-1">
                            <div class="card">
                                ...
                                {!! html()->form('POST', route('comment.store'))->attribute('class', 'form-horizontal')->attribute('data-validate')->open() !!}
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="text-end">
                                        {!! html()->button(__('Add a comment'))->type('submit')->class('btn btn-primary') !!}
                                    </div>
                                    {!! html()->form()->close() !!}
                                    @foreach ($poll->commmant as $value)
                                        <div class="comments-item">
                                            ...
                                            <span class="text-left comment-info">
                                                ...
                                                <h6 class="d-block">
                                                    ...
                                                    {!! html()->form('DELETE', route('comment.destroy', $value->id))->attribute('id', 'delete-form-' . $value->id)->attribute('class', 'd-inline')->open() !!}
                                                    {!! html()->a('javascript:void(0)')->attribute('class', 'text-dark show_confirm')->attribute('title', 'Delete')->attribute('id', 'delete-form-' . $value->id)->text(__('Delete')) !!}
                                                    {!! html()->form()->close() !!}
                                                </h6>
                                        ...
                                        <div class="row commant" id="reply-comment-{{ $value->id }}">
                                            ...
                                            <div class="card-footer">
                                                <div class="text-end">
                                                    {!! html()->button(__('Add a Reply'))->type('submit')->class('btn btn-primary') !!}
                                                </div>
                                            </div>
                                        </div>
                                        {!! html()->form()->close() !!}
