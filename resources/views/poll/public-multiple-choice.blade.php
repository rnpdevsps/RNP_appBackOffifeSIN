...
@section('content')
    <div class="row">
        {!! html()->modelForm($poll, 'POST', route('fill.poll.store', $poll->id))->attribute('data-validate')->class('form-horizontal')->open() !!}
        <div class="row">
        ...
        <div class="row">
            <div class="mx-auto col-xl-7 order-xl-1">
                <div class="card">
                    ...
                    {!! html()->form('POST', route('comment.store'))->class('card-body')->open() !!}
                    <div class="card-body">
                        <div class="form-group">
