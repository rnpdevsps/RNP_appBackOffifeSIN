...
@section('title', __('Editar Mae Plantilla'))
@section('breadcrumb')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h4 class="m-b-10">{{ __('Editar Mae Plantilla') }}</h4>
                    </div>
                    <ul class="breadcrumb">
        ...
        <div id="basic" class="mx-auto col-lg-6 layout-spacing">
            <div class="statbox card box box-shadow">
                <div class="card-header">
                    <h5>{{ __('Editar Mae Plantilla') }}</h5>
                </div>
                {!! Form::model($dataTable, [
                    'route' => ['maeplantillas.update', $dataTable->id],
                    'method' => 'PUT',
                    'data-validate',
                ]) !!}
                <div class="card-body">
