...
@section('title', __('Editar compareciente'))
@section('content')
        ...
        <div id="basic" class="mx-auto col-lg-6 layout-spacing">
            <div class="statbox card box box-shadow">
                <div class="card-header">
                    <h5>{{ __('Editar compareciente') }}</h5>
                </div>
                {!! Form::model($compareciente, ['route' => ['comparecientes.update', $compareciente->id], 'method' => 'PUT', 'data-validate' ]) !!}
                <div class="card-body">
                    <div class="row">
