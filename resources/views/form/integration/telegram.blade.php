            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Telegram Access Token'), 'telegram_access_token' . $telegramJsonkey)->class('form-label') !!}
                        {!! html()->text(
                                'telegram_access_token[]',
                                isset($telegramJson['telegram_access_token']) ? $telegramJson['telegram_access_token'] : null,
                            )->class('form-control')->id('telegram_access_token' . $telegramJsonkey)->required()->placeholder(__('Enter telegram access token')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Telegram Chat Id'), 'telegram_chat_id' . $telegramJsonkey)->class('form-label') !!}
                        {!! html()->text('telegram_chat_id[]', isset($telegramJson['telegram_chat_id']) ? $telegramJson['telegram_chat_id'] : null)->class('form-control')->id('telegram_chat_id' . $telegramJsonkey)->required()->placeholder(__('Enter telegram chat id')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
