            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Html::label('clicktell_number' . $clicktellJsonkey, __('Clicktell Number'))->class('form-label') !!}
                        {!! Html::number(
                            'clicktell_number[]',
                            isset($clicktellJson['clicktell_number']) ? $clicktellJson['clicktell_number'] : null,
                        )->class('form-control')->id('clicktell_number' . $clicktellJsonkey)->required()->placeholder(__('Enter clicktell number')) !!}
                        <small>{{ __('Note: Please enter the mobile number for send sms. Example: 911234567890') }}</small>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Html::label('clicktell_api_key' . $clicktellJsonkey, __('Clicktell Api Key'))->class('form-label') !!}
                        {!! Html::text(
                            'clicktell_api_key[]',
                            isset($clicktellJson['clicktell_api_key']) ? $clicktellJson['clicktell_api_key'] : null,
                        )->class('form-control')->id('clicktell_api_key' . $clicktellJsonkey)->required()->placeholder(__('Enter clicktell api key')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Html::label('clicktell_field' . $clicktellJsonkey, __('Clicktell Field'))->class('form-label') !!}
