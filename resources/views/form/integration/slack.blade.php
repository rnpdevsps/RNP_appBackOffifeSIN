            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Slack Webhook URL'), 'slack_webhook_url' . $slackJsonkey)->class('form-label') !!}
                        {!! html()->text('slack_webhook_url[]', isset($slackJson['slack_webhook_url']) ? $slackJson['slack_webhook_url'] : null)->class('form-control')->id('slack_webhook_url' . $slackJsonkey)->required()->placeholder(__('Enter Slack webhook url')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Slack Field'), 'slack_field' . $slackJsonkey)->class('form-label') !!}
