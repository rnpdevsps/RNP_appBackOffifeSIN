            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Html::label('bulkgate_number' . $bulkgateJsonkey, __('Bulkgate Number'))->class('form-label') !!}
                        {!! Html::number(
                            'bulkgate_number[]',
                            isset($bulkgateJson['bulkgate_number']) ? $bulkgateJson['bulkgate_number'] : null,
                        )->class('form-control')->id('bulkgate_number' . $bulkgateJsonkey)->required()->placeholder(__('Enter bulkgate number')) !!}
                        <small>{{ __('Note: Please enter the mobile number for send sms. Example: 1234567890') }}</small>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Html::label('bulkgate_token' . $bulkgateJsonkey, __('Bulkgate Token'))->class('form-label') !!}
                        {!! Html::text(
                            'bulkgate_token[]',
                            isset($bulkgateJson['bulkgate_token']) ? $bulkgateJson['bulkgate_token'] : null,
                        )->class('form-control')->id('bulkgate_token' . $bulkgateJsonkey)->required()->placeholder(__('Enter bulkgate token')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Html::label('bulkgate_app_id' . $bulkgateJsonkey, __('Bulkgate App Id'))->class('form-label') !!}
                        {!! Html::text(
                            'bulkgate_app_id[]',
                            isset($bulkgateJson['bulkgate_app_id']) ? $bulkgateJson['bulkgate_app_id'] : null,
                        )->class('form-control')->id('bulkgate_app_id' . $bulkgateJsonkey)->required()->placeholder(__('Enter bulkgate app id')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! Html::label('bulkgate_field' . $bulkgateJsonkey, __('Bulkgate Field'))->class('form-label') !!}
