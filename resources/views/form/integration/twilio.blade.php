            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Twilio Mobile Number'), 'twilio_mobile_number' . $twilioJsonkey)->class('form-label') !!}
                        {!! html()->number(
                                'twilio_mobile_number[]',
                                isset($twilioJson['twilio_mobile_number']) ? $twilioJson['twilio_mobile_number'] : null,
                            )->class('form-control')->id('twilio_mobile_number' . $twilioJsonkey)->required()->placeholder(__('Enter twilio mobile number')) !!}
                        <small>{{ __('Note: Please enter the mobile number for send sms. Example: 911234567890') }}</small>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Twilio Sid'), 'twilio_sid' . $twilioJsonkey)->class('form-label') !!}
                        {!! html()->text('twilio_sid[]', isset($twilioJson['twilio_sid']) ? $twilioJson['twilio_sid'] : null)->class('form-control')->id('twilio_sid' . $twilioJsonkey)->required()->placeholder(__('Enter twilio sid')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Twilio Auth Token'), 'twilio_auth_token' . $twilioJsonkey)->class('form-label') !!}
                        {!! html()->text('twilio_auth_token[]', isset($twilioJson['twilio_auth_token']) ? $twilioJson['twilio_auth_token'] : null)->class('form-control')->id('twilio_auth_token' . $twilioJsonkey)->required()->placeholder(__('Enter twilio auth token')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Twilio Number'), 'twilio_number' . $twilioJsonkey)->class('form-label') !!}
                        {!! html()->text('twilio_number[]', isset($twilioJson['twilio_number']) ? $twilioJson['twilio_number'] : null)->class('form-control')->id('twilio_number' . $twilioJsonkey)->required()->placeholder(__('Enter twilio number')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Twilio Field'), 'twilio_field' . $twilioJsonkey)->class('form-label') !!}
