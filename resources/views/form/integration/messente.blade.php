            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Messente Number'), 'messente_number' . $messenteJsonkey)->class('form-label') !!}
                        {!! html()->number('messente_number[]', isset($messenteJson['messente_number']) ? $messenteJson['messente_number'] : null)->class('form-control')->id('messente_number' . $messenteJsonkey)->required()->placeholder(__('Enter messente number')) !!}
                        <small>{{ __('Note: Please enter the mobile number for send sms. Example: 911234567890') }}</small>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Messente Api Username'), 'messente_api_username' . $messenteJsonkey)->class('form-label') !!}
                        {!! html()->text(
                                'messente_api_username[]',
                                isset($messenteJson['messente_api_username']) ? $messenteJson['messente_api_username'] : null,
                            )->class('form-control')->id('messente_api_username' . $messenteJsonkey)->required()->placeholder(__('Enter messente api username')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Messente Api Password'), 'messente_api_password' . $messenteJsonkey)->class('form-label') !!}
                        {!! html()->text(
                                'messente_api_password[]',
                                isset($messenteJson['messente_api_password']) ? $messenteJson['messente_api_password'] : null,
                            )->class('form-control')->id('messente_api_password' . $messenteJsonkey)->required()->placeholder(__('Enter messente api password')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Messente Sender'), 'messente_sender' . $messenteJsonkey)->class('form-label') !!}
                        {!! html()->text('messente_sender[]', isset($messenteJson['messente_sender']) ? $messenteJson['messente_sender'] : null)->class('form-control')->id('messente_sender' . $messenteJsonkey)->required()->placeholder(__('Enter messente sender')) !!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        {!! html()->label(__('Messente Field'), 'messente_field' . $messenteJsonkey)->class('form-label') !!}
