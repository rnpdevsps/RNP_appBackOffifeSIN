...
@section('content')
    <div class="row">
        <div class="m-auto col-lg-8 col-md-8 col-sm-12 col-12">
            {!! html()->form('POST', route('rule.store'))->attribute('id', 'form-rule')->attribute('data-validate', '')->attribute('novalidate', '')->open() !!}
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="mb-6 form-group">
                            ...
                            {!! html()->text('rule_name')->class('form-control')->placeholder('Enter Rule name') !!}
                            <small>{{ '(Maximum 50 characters)' }}</small>
                            <input type="hidden" name="form_id" value="{{ $formRules->id }}">
                        </div>

                        <div class="mb-6 form-group condition-select d-none w-25">
                                ...
                                <div class="col-10">
                                    <div class="repeater">
                                        <div data-repeater-list="rules">
                                            <div data-repeater-item class="py-2 border-bottom">
                                                <div class="row count-row">
                                                                ...
                                                                @foreach ($jsons as $json)
                                                                    @if (
                                                                        ...
                                                                        @if (isset($json->name) && isset($json->label))
                                                                            @php
                                                                                $ifDataFieldNames = [];
                                                                                $rules = App\Models\FormRule::where(
                                                                                    'form_id',
                                                                                    $formRules->id,
                                                                                )->get();
                                                                            @endphp
                                                                            ...
                                                                            @foreach ($rules as $rule)
                                                                                @php
                                                                                    $ifJsonArray = json_decode(
                                                                                        $rule->if_json,
                                                                                        true,
                                                                                    );
                                                                                    foreach ($ifJsonArray as $ifData) {
                                                                                        $ifDataFieldNames[] =
                                                                                            $ifData['if_field_name'];
                                                                                    }
                                                                                @endphp
                                                                            @endforeach
                                                    ...
                                                    <div class="col-lg-3 input-container">
                                                        {!! html()->text('if_rule_value')->class('form-control')->id('if_rule_value') !!}
                                                    </div>
                                                    <div class="col-lg-1">
                                                        <input data-repeater-delete class="p-2 btn btn-danger"
                                        ...
                                        <div class="col-lg-1">
                                            <input data-repeater-create class="p-2 btn btn-primary add-repeater-button"
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <div class="repeater2">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select name="else_field_name" id="else_field_name"
                                                            ...
                                                            @php
                                                                $thenDataFieldNames = [];
                                                                foreach ($rules as $rule) {
                                                                    $ThenJsonArray = json_decode(
                                                                        $rule->then_json,
                                                                        true,
                                                                    );
                                                                    foreach ($ThenJsonArray as $thenData) {
                                                                        $thenDataFieldNames = array_merge(
                                                                            $thenDataFieldNames,
                                                                            $thenData['else_field_name'],
                                                                        );
                                                                    }
                                                                }
                                                            @endphp
                                        ...
                                        <div class="col-lg-1">
                                            <input data-repeater-create class="p-2 btn btn-primary " type="button"
                                                value="Add" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-footer text-end">
                    {!! html()->button(__('Save'))->class('btn btn-primary')->id('save-btn')->type('submit') !!}
                </div>
            </div>
        </div>
                            ...
                            @foreach ($rules as $rule)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {!! html()->form('DELETE', route('rule.delete', $rule->id))->attribute('class', 'd-inline')->attribute('id', 'delete-form-' . $rule->id)->open() !!}
                                        {!! html()->a('javascript:void(0)', __('Delete'))->class('btn btn-sm small btn-danger show_confirm')->attribute('data-bs-toggle', 'tooltip')->attribute('data-bs-placement', 'bottom')->attribute('id', 'delete-form-' . $rule->id)->attribute('data-bs-original-title', __('Cancel Rule'))->attribute('aria-label', __('Cancel Rule')) !!}
                                        {!! html()->form()->close() !!}
                                    </td>
                                </tr>
                            @endforeach
