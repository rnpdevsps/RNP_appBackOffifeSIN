{!! html()->form('POST', route('apikey.store'))->attribute('data-validate')->open() !!}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="form-group ">
                {!! html()->label(__('Dias Disponible'))->class('col-form-label') !!}
                {!! html()->number('expira')->class('form-control')->placeholder(__('365'))->required() !!}
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="form-group ">
                ...
                {!! html()->text('api_key', $key)->class('form-control')->attribute('readonly')->placeholder(__('apikey'))->required() !!}
            </div>
        </div>
