        ...
        <tr>
            <td align="center" valign="center" style="text-align:center; padding: 40px">
                <a href="#" rel="noopener" target="_blank">
                    <img src="{{ Utility::getsettings('app_logo') ? Storage::url('app-logo/app-logo.png') : Storage::url('app-logo/78x78.png') }}" class="app-logo" width="50%" />
                </a><br>
                <h1 align="center" valign="center" style="text-align:center;">REGISTRO NACIONAL DE LAS PERSONAS</h1>
            </td>
        </tr>
        <tr>
