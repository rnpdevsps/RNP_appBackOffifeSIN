...
# {{ $booking_value->Booking->business_name }}
...
<div class="text-center">
 {!! html()->img(asset('storage/app/' . $booking_value->Booking->business_logo))->id('app-dark-logo')->class('img img-responsive my-5 w-30 justify-content-center text-center')->alt('Image Description') !!}
 </div>
@endif
<table class="table table-bordered" style="width: 100%">
@foreach ($booking_valuearray as $rows)
