                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a href="javascript:void(0);" data-url="{{ route('header.menu.create') }}"
                                        ...
                                        class="mx-1 btn btn-sm btn-primary header-menu-create"
                                                        ...
                                                        <span class="d-flex">
                                                            <div>
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    class="mx-1 btn btn-sm btn-primary header-menu-edit"
                                                                    data-bs-original-title="{{ __('Edit') }}">
                                                                    <i class="ti ti-pencil text-light"></i>
                                                                </a>
                                                            </div>
                                                            {!! html()->form('DELETE', route('header.menu.delete', $headerMenu->id))->class('d-inline')->id('delete-form-' . $headerMenu->id)->open() !!}
                                                            <a href="javascript:void(0);"
