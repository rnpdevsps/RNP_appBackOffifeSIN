                    ...
                    <div class="card">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="menu-setting" role="tabpanel"
                                ...
                                {!! html()->form('POST', route('landing.footer.store'))->attribute('id', 'froentend-form')->attribute('data-validate')->attribute('novalidate')->open() !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 d-flex justify-content-end">
                                            <div class="form-switch custom-switch-v1 d-inline-block">
                                                {!! html()->checkbox('footer_setting_enable', Utility::getsettings('footer_setting_enable') == 'on', null)->class('custom-control custom-switch form-check-input input-primary')->id('featureSettingEnableBtn')->attribute('data-onstyle', 'primary')->attribute('data-toggle', 'switchbutton') !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                {!! html()->label(__('Footer Description'), 'footer_description')->class('form-label') !!}
                                                {!! html()->textarea('footer_description', Utility::getsettings('footer_description'))->class('form-control')->rows(3)->placeholder(__('Enter footer description')) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a href="javascript:void(0);" data-url="{{ route('footer.main.menu.create') }}"
                                        ...
                                        class="mx-1 btn btn-sm btn-primary footer_menu_create"
                                                        ...
                                                        <span class="d-flex">
                                                            <div>
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    class="mx-1 btn btn-sm btn-primary footer_main_menu_edit"
                                                                    data-bs-original-title="{{ __('Edit') }}">
                                                                    <i class="ti ti-pencil text-light"></i>
                                                                </a>
                                                            </div>
                                                            {!! html()->form('DELETE', route('footer.main.menu.delete', $footerMainMenu->id))->class('d-inline')->id('delete-form-' . $footerMainMenu->id)->open() !!}
                                                            <a href="javascript:void(0);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="d-flex">
                                                            ...
                                                            {!! html()
                                                                ->form('DELETE', route('footer.sub.menu.delete', $footerSubMenu->id))
                                                                ->attribute('class', 'd-inline')
                                                                ->attribute('id', 'delete-form-' . $footerSubMenu->id)
                                                                ->open() !!}
                                                                <a href="javascript:void(0);"
                                                                   class="btn btn-sm small btn-danger show_confirm"
