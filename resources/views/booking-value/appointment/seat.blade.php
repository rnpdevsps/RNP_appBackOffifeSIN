                    ...
                    <div class="row invoive-info d-print-inline-flex">
                            ...
                            <table class="table mt-0 table-responsive invoice-table invoice-order table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-1">{{ $bookingValue->booking_seats }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ 'Status' }} :</th>
                                        <td>
                        ...
                        <div class="col-sm-4">
                            @if ($bookingValue->booking_status == 1)
                                ...
                                {!! html()->a('javascript:void(0)')->class('btn btn-sm small btn-danger show_confirm')->id('delete-form-' . $bookingValue->id)->attribute('data-bs-toggle', 'tooltip')->attribute('data-bs-placement', 'bottom')->attribute('data-bs-original-title', __('Cancel Slots'))->attribute('aria-label', __('Cancel Slots'))->text(__('Cancel Slots')) !!}
                                {!! html()->form()->close() !!}
                            @endif
                        </div>
                    </div>
