    ...
    @php
        ...
        if ($marcaje) {
            if ($marcaje->hora_salida == null ){
                ...
                $salida = $marcaje->hora_salida ? \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $marcaje->hora_salida) : null;

            }

            $horaEntrada = $marcaje->hora_entrada ? \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $marcaje->hora_entrada)->format('H:i:s') : null;
            $horaSalida = $salida;
            ...
            // Día sin registro: sumar 480 minutos
            $horaEntrada = null;
            $horaSalida = null;
            $minutosTarde = 480;
