            ...
            <div class="statbox card box box-shadow">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="usuario" class="col-form-label">Usuario: {{ $usuario }}</label>
                            </div>
                        </div>

                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="status_contrato" class="col-form-label">Estado del Contrato: {{ $status_contrato }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    <select name="status_contrato" id="status_contrato" class="form-select">
                                        <option value="1">Local propio</option>
                                        <option value="2">Posible cambio</option>
                                        <option value="3">Aumento</option>
                                        <option value="4">Firmado</option>
                                    </select>
                                </div>
                            </div>
                        </div>
