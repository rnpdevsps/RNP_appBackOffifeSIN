...
<div class="master">
    <div class="box" style="width: 550px">
        ...
        <div class="main">
            <p>Please set below directory and file permission to <b>666</b> and reload page.</p>
            <ul class="list">
                ...
                { ?>
                    ...
                    <li class="list__item list__item--permissions <?php if($val == '666')
                    {
                        echo 'success';
                    }
                    else
                    {
                        ...
                        <?php if($val < '666')
                        {
                            echo "<small>(Required Permission is 666)</small>";
                        } ?>
                        <span>
                            <?php if($val == '666') { ?>
